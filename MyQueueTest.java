...
public class MyQueueTest {
	...
	public void testDequeueStudent() throws QueueUnderflowException {
		...
		assertEquals(Double.valueOf(30.0), doubleQ.dequeue());
		assertEquals(Double.valueOf(10.0), doubleQ.dequeue());
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("30.010.040.0", doubleQ.toString());
	}

	@Test
	public void testToStringDelimiter() throws Exception {
